...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ValidateToken = channel.unary_unary(
                '/com.auth.AuthService/ValidateToken',
                request_serializer=auth__pb2.ValidationTokenRequest.SerializeToString,
                response_deserializer=auth__pb2.ValidationTokenResponse.FromString,
                _registered_method=True)
        self.RegisterUser = channel.unary_unary(
                '/com.auth.AuthService/RegisterUser',
        ...
        self.LoginUser = channel.unary_unary(
                '/com.auth.AuthService/LoginUser',
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ValidateToken': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=auth__pb2.ValidationTokenRequest.FromString,
                    response_serializer=auth__pb2.ValidationTokenResponse.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'com.auth.AuthService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('com.auth.AuthService', rpc_method_handlers)
...
class AuthService(object):
    ...
    def ValidateToken(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/com.auth.AuthService/ValidateToken',
            auth__pb2.ValidationTokenRequest.SerializeToString,
            auth__pb2.ValidationTokenResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
